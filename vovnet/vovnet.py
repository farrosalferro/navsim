...
from vovnet.layers.batch_norm import FrozenBatchNorm2d,get_norm
from vovnet.layers.shape_spec import ShapeSpec
from vovnet.backbones.build import BACKBONE_REGISTRY
from vovnet.backbones.backbone import Backbone
from vovnet.backbones.fpn import FPN, LastLevelMaxPool
...
def build_vovnet_backbone(cfg, input_shape):
    ...
    """
    out_features = cfg['VOVNET_OUT_FEATURES']
